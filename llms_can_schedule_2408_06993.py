# -*- coding: utf-8 -*-
"""LLMs_can_Schedule_2408_06993_(2).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kSZWPXBVHxq2X7yGQJRDnh9YXQpVIEop
...
# !unzip llm-can-schedule/jssp_phi3_lora.zip -d /content/jssp_phi3_lora_loaded

# # ── 11b. Upload zip and extract ──────────────────────────────────────────────
# import zipfile, shutil, pathlib
# from google.colab import files as colab_files

# LOAD_DIR = "/content/jssp_phi3_lora"

# print("Select your jssp_phi3_lora.zip file …")
# uploaded = colab_files.upload()          # opens the file picker

# zip_name = next(iter(uploaded))          # filename of what was uploaded
# zip_path = f"/content/{zip_name}"

# # Write bytes to disk (colab_files.upload returns {name: bytes})
# with open(zip_path, "wb") as f:
#     f.write(uploaded[zip_name])

# # Extract
# if pathlib.Path(LOAD_DIR).exists():
...
# files_found = list(pathlib.Path(LOAD_DIR).rglob("*"))
# print(f"\n✓ Extracted {len(files_found)} files → {LOAD_DIR}")
# for p in sorted(files_found)[:12]:
#     print(f"  {p.relative_to(LOAD_DIR)}")
# if len(files_found) > 12:
#     print(f"  … and {len(files_found)-12} more")
