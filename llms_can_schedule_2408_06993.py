...
Original file is located at
    https://colab.research.google.com/github/jyasuu/llm-can-schedule/blob/main/LLMs_can_Schedule_2408_06993.ipynb
...
!cd ./llm-can-schedule/jssp_llm/ && ~/.cargo/bin/cargo build   --release --features cuda

!unzip llm-can-schedule/jssp_phi3_lora.zip -d /content/jssp_phi3_lora

!cd llm-can-schedule && git pull
!rm ./llm-can-schedule/jssp_llm/Cargo.lock
!cd ./llm-can-schedule/jssp_llm/ && ~/.cargo/bin/cargo run --release --features cuda -- --adapter-dir /content/jssp_phi3_lora --device 0 benchmark --samples 10 --max-new-tokens 256

!llm-can-schedule/jssp_llm/target/release/jssp_llm --adapter-dir /content/jssp_phi3_lora --device 0 benchmark --samples 2 --max-new-tokens 1024