...
impl TransformerLLM {
    ...
    pub fn count_parameters(&self) -> usize {
        ...
        let attention_params =
            self.config.num_layers * (self.config.hidden_dim * self.config.hidden_dim * 4); // Q, K, V, O projections
    ...
    pub fn lora_parameters(&self) -> usize {
        ...
        let lora_params = self.config.num_layers * (self.config.hidden_dim * rank * 2); // A and B matrices
